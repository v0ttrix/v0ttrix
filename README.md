...
<div align="left" style="line-height: 1.2; margin-bottom: 0;">
  ...
  <img src="https://skillicons.dev/icons?i=c,cs,cpp,python,java,js,html,css,mysql,docker,azure,git,autocad,arduino,raspberrypi,kali,ubuntu,unity,powershell,wordpress,linux,windows,apple,visualstudio,vscode,clion,qt&perline=9&theme=dark" style="margin-top: -6px;" />
</div>
